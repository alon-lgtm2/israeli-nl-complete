...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-sm font-medium text-[var(--color-text-secondary)]">שתפו:</span>
      ...
      <a
        ...
        className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#25D366] text-white hover:opacity-80 transition-opacity"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#1877F2] text-white hover:opacity-80 transition-opacity"
